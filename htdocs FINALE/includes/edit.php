...
<body>
    ...
    <?php
            ...
            $sql = "SELECT * FROM rezepte WHERE id =" .$id ."";
                ...
                echo "<h2>Dein Rezept bearbeiten</h2>";
                ...
                echo  "Zutat 4 : <br><input type='text' name='ingredient4' id='ingredient4' value = '" . $row['ingredient4'] ."'><br></div>";
                echo  "<div class='col-3 col-s-12'>Zutat 5 : <br><input type='text' name='ingredient5' id='ingredient5' value = '" . $row['ingredient5'] ."'><br>";
                echo  "Zutat 6 : <br><input type='text' name='ingredient6' id='ingredient6' value = '" . $row['ingredient6'] ."'><br>";
                ...
                echo  "Kategorie 1 : <br><input type='text' name='cathegory1' id='cathegory' value = '" . $row['cathegory1'] ."'><br>"; 
