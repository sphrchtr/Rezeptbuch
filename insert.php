...
$sql = "INSERT INTO persons (namerecipe, preparation, difficulty, ingredient1 , ingredient2 , ingredient3 , ingredient4 , ingredient5 , ingredient6 , ingredient7 , ingredient8 , ingredient9 , ingredient10 , cathegory1 , cathegory2 , cathegory3 , time , amount ,  source ) VALUES ('$namerecipe', '$preparation', '$difficulty','$ingredient1','$ingredient2','$ingredient3','$ingredient4','$ingredient5','$ingredient6','$ingredient7','$ingredient8','$ingredient9','$ingredient10','$cathegory1','$cathegory2','$cathegory3','$time','$amount', '$source')";
